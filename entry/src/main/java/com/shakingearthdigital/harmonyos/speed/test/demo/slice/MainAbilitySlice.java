...
public class MainAbilitySlice extends AbilitySlice {
    ...
    public static String downloadFile = ""; //TODO replace with a URL to download
    ...
    private void runTimer() {
        ...
        downloadTime.setText(String.format("Download Time: %.2f s", duration/1000f));
        downloadSize.setText(String.format("Download Size: %.2f MB", currSize/1048576f));
    ...
    public void setState(PlayState state){
        switch (state){
            case IDLE:
                ...
                downloadSize.setText("Download Size: --");
                break;
            case RUNNING:
